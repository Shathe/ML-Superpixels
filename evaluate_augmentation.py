...
# python accuracy.py --points labels10  --generated 10labels-ignore-fluor-0.793 --classes 10
...
for folder in folders:
	...
	# For every image
	for filename in glob.glob(args.labels + folder + '/*.*'):
		print(filename)
		count = count 
		...
		generated = cv2.imread(args.generated + folder  + "/" + name, cv2.IMREAD_GRAYSCALE)
		print(generated)
